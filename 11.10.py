...
async def main():
 ...
 task1 = asyncio.create_task(tester("1tet"))
...
item = res_html.select_one("body > div.container")
...
hmltxt = res.text
res_html = bs(hmltxt,'html.parser')
item = res_html.select_one("#content_table")

print(item)
print(item.get_text())

wt=res_html.select_one("#content_table")
print(wt)
print(wt.get_text())

goods = res_html.select_one("#content_table")
print(goods)
